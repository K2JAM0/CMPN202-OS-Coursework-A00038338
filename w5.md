...
═══════════════════════════════════════════════════════
My reflection: I learnt that instead of manually providing settings everytime, I can run one command and capture consistent evidence. Writing scripts made it more efficient.
